...
const gallery_data =
{
    ...
    "events": {
        ...
        "textCards": {
            "11": {
                ...
                да се потопите в българските традиции.  Тази година събитието бе оживено от участието на <a href="https://www.facebook.com/bghajduti">сдружение "Хайдути"</a>, както и 
    ...
    "weddings": {
        ...
        "textCards": {
            ...
            "4": {
                "id": "",
                "title": "",
                "content": `Разгледайте сватбената ни галерия, за да откриете още вдъхновяващи фотографии. Ние предлагаме разнообразни услуги - от сватбени и абитуриентски фотосесии до заснемане на специални събития, като гарантираме висококачествени и емоционално наситени снимки.
    ...
    "products": {
        ...
        Разгледайте галерията ни, за да видите още примери от нашата професионална продуктова фотография.`,
            ...
            "15": {
                "id": "alinea_session",
                "title": "Крафт моделист на интериорни пространства",
                "content": `Заповядайте да разгледате галерията ни и да се потопите в света на професионалната интериорна фотография, където вдъхновението среща реалността!`,
                "card_size": ""
            }
        }
...
function highlightOpen() {
    ...
    let homeButton = document.querySelectorAll('.menu #home')[0];
